...
const Navbar = memo(function Navbar() {
  ...
  return (
    <header 
      className={cn(
        "fixed top-0 left-0 right-0 z-50 w-full flex h-16 items-center gap-3 border-b bg-[var(--bg-primary)]/80 backdrop-blur-xl border-[var(--border-color)] px-4 lg:px-6 transition-all duration-300"
      )}
    >
      <button
